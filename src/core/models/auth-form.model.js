export const model  = controls => {
    return `<div class="img-wrapper d-flex justify-content-center mb-5">
                <img src="../assets/brand-notate.svg" alt="brand-notate" class="auth-form-img d-flex">
            </div>
            <div class="controls-wrapper d-flex flex-column">
                <input class="mb-3 form-control" type="email" name="${controls.input_login}" id="${controls.input_login}" placeholder="Email" autocomplete = "off">
                <input class="mb-3 form-control" type="password" name="${controls.input_password}" id="${controls.input_password}" placeholder="Password">
                <div class="text-center mb-3 animated-hidden transition-hidden text-danger" id="auth-form-tooltip"></div>
